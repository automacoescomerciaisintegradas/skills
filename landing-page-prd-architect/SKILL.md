...
description: 'Especialista em criar PRDs (Product Requirements Documents) técnicos
  ultra detalhados para geração de landing pages e sites premium usando Gemini CLI
