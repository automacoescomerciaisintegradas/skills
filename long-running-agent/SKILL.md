...
description: This skill should be used when developing complex projects that span
  multiple sessions or context windows. It implements the Long-Running Agent Protocol
  based on Anthropic's recommended practices for maintaining progress across sessions
  using SubAgents with isolated context windows, progress tracking files, and incremental
  feature development.
category: backend
---
