...
description: This skill should be used when the user asks to "create a prompt for
  Lisa", "generate PROMPT.md", "write specs for Lisa loop", "prepare Lisa execution",
  mentions "Lisa plugin", "iterative loops", "spec-based verification", or discusses
  creating high-quality prompts with completion promises and verification steps for
