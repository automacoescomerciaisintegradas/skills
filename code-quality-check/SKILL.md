...
description: 'Comprehensive code quality verification for Node.js/TypeScript projects
  before production deployment.

  Executes Prettier (formatting), ESLint (linting), TypeScript (type checking), and
  test runners.
