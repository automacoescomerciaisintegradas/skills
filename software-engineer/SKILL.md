...
description: 'Ultra Senior Software Engineer (15+ years experience) with absolute
  mastery in building, evolving and maintaining production software. Use this skill
  for any software development task including: implementing features (backend, frontend,
  mobile), writing clean/testable/performant code, creating automated tests, fixing
  bugs, refactoring, code reviews, and working with product teams. This skill embodies
  Principal/Staff Engineer expertise with deep knowledge of debugging, testing strategies,
